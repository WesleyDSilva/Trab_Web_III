    ...
    <div class="container-fluid">
        <div class="row justify-content-around">
             <div class="card col-md-3">
                 <img class="card-img-top text-center mx-auto" src="img/meat.png" alt="Card image cap">
                 <div class="card-body">
                     <h5 class="card-title">Sanduiche</h5>
                     <p class="card-text">Sanduiche de carne</p>
                     <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Peça agora</a>                    
                 </div>
             </div>

             <div class="card col-md-3">
                 <img class="card-img-top text-center mx-auto" src="img/churros.png" alt="Card image cap">
                 <div class="card-body">
                     <h5 class="card-title">Churros</h5>
                     <p class="card-text">Doce de leite</p>
                     <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Peça agora</a>                    
                 </div>
             </div>

             <div class="card col-md-3">
                 <img class="card-img-top text-center mx-auto" src="img/chicken.png" alt="Card image cap">
                 <div class="card-body">
                     <h5 class="card-title">Sanduiche</h5>
                     <p class="card-text">Sanduiche de frango</p>
                     <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Peça agora</a>                    
                 </div>
             </div>

             <div class="card col-md-3">
                 <img class="card-img-top text-center mx-auto" src="img/steak.png" alt="Card image cap">
                 <div class="card-body">
                     <h5 class="card-title">Sanduiche</h5>
                     <p class="card-text">Sanduiche de carne de porco</p>
                     <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Peça agora</a>                    
                 </div>
             </div>               
         </div>
